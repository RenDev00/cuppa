...
const emojiKeywords = {
    ...
    '👩‍👩‍👦': ['family', 'two women boy'],
    '👩‍👩‍👧': ['family', 'two women girl'],
    '👩‍👩‍👧‍👦': ['family', 'two women boy girl'],
    '👩‍👩‍👦‍👦': ['family', 'two women boys'],
    '👩‍👩‍👧‍👧': ['family', 'two women girls'],
    '👨‍👦': ['family', 'man boy'],
    '👨‍👦‍👦': ['family', 'man boys'],
    '👨‍👧': ['family', 'man girl'],
    '👨‍👧‍👦': ['family', 'man girl boy'],
    ...
    '🧑‍✈️': ['pilot', 'aviator', 'airplane'],
    '🧑‍🚀': ['astronaut', 'space'],
    '🧑‍🚒': ['firefighter', 'fire'],
    '🧑‍⚖️': ['judge', 'justice', 'court'],
    '🧑‍🦲': ['person bald', 'bald'],
    '🧑‍🦳': ['person white hair', 'white hair'],
    '🧑‍🦱': ['person curly hair', 'curly hair'],
    '🧑‍🦰': ['person red hair', 'red hair'],
    '🧔‍♂️': ['man beard', 'beard'],
    '🧔‍♀️': ['woman beard', 'beard'],
    '👸': ['princess', 'royal', 'woman'],
    '🤴': ['prince', 'royal', 'man'],
    '👼': ['baby angel', 'angel'],
    '🎅': ['santa claus', 'santa', 'christmas'],
    ...
    '🧎': ['kneeling person', 'kneeling'],
    '🈴': ['squared cjk', 'japanese'],
    '🈚': ['squared cjk', 'japanese'],
    '🈹': ['squared cjk', 'japanese'],
    '🈲': ['squared cjk', 'japanese'],
    ...
    '📛': ['name badge', 'badge'],
    '🚫': ['prohibited', 'no', 'ban'],
    '♨️': ['hot springs', 'onsen', 'hot'],
    '🚷': ['no pedestrians', 'pedestrian'],
    '🚯': ['no littering', 'litter'],
    '🚳': ['no bicycles', 'bicycle'],
